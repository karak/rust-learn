...
- **実装は段階 3 まで完了。段階 4（イテレータとクロージャ）は未着手。**
...
## 次の作業: 段階 4（イテレータとクロージャ）

課題の内容は `docs/curriculum.md` の段階 4 が正本。ここには着手手順だけを書く。

**着手前にやること**:

1. **完了条件を先に `docs/curriculum.md` に書く**（段階 3 で有効だった手順）
2. **段階 3 で未消化の概念を回収できるか見る。** 孤児ルール、
